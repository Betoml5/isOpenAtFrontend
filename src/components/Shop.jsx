...
export const Shop = () => {
  return (
    <div className="flex my-4 justify-between bg-restaurant bg-no-repeat  bg-cover relative rounded-2xl  p-4 h-44 cursor-pointer self-center justify-self-center">
